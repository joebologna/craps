...
app_store:
	../fyne/cmd/fyne/fyne package -os ios -certificate "Apple Distribution: Focused for Success, Inc. (2GC862GT48)" -profile "Craps App Store" -release
...
gen:
	go run cmd/gen_appversion.go > appversion.go; go fmt appversion.go
